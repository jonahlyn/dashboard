...
app.layout = html.Div(children=[
    ...
    html.H1('Roadway Usage Statistics'),

    dcc.Graph( id='main-graph', figure={'data':get_graph_data(), 'layout':get_graph_layout("")}, config=get_graph_config() ),
